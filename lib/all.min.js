...
function _search() { var text = ""; $("input.search").each(function () { if ($(this).val() != "") { text = $(this).val();
//~ $(this).val("");
} }); if (text == "") { return; } var hash = "search=" + text; var oldhash = decodeURI(window.location.hash); if (oldhash.substr(0,1) == "#") { oldhash = oldhash.substr(1); } if (hash != oldhash) { history.pushState(null,null,"#" + hash); }
// ACTUALITZAR COOKIE PER MES ENDAVANT
$.cookie("hash",hash,{expires:365,path:"/"});
// DESACTIVAR ANTIGA SELECCIO
$("#menu button.active").removeClass("active"); $("#menu .collapse.show").removeClass("show"); $("#menu a.active").removeClass("active");
