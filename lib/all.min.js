...
var params = new URLSearchParams(window.location.search); if (params.has("hash")) { hash = decodeURI(params.get("hash")); } if (hash.substr(0,7) != "search=" && !data.songs.hasOwnProperty(hash)) {
