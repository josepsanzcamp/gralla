...
function _pdf(hash)
{
    ...
    for (var key in data.songs[hash].pages) {
        ...
        document.getElementById("pdf").append(saltos.html('<img src="' + img + '" class="img-fluid w-100 mb-3 shadow border ' + colors[color % 2] + '" loading="lazy" width="' + width + '" height="' + height + '" alt="' + alt + '"/>'));
        color++;
    }
    document.getElementById("pdf").classList.remove("d-none");
}
