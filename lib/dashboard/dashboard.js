...
$(function () {
    ...
    $(window).on("hashchange",function () {
        ...
        $("#menu .collapse.show").each(function () {
            new bootstrap.Collapse(this);
        });
        $("#menu a.active").removeClass("active");
        // AMAGAR CERCADOR I MENU
        $("#result").addClass("d-none");
        $("#sidebarMenu.show").each(function () {
            new bootstrap.Collapse(this);
        });
        // CHECK
        if (hash.substr(0,7) != "search=") {
            ...
            $("input.search").val(hash.substr(7));
            // PINTAR CERCADOR
            _search();
        }
    ...
    $("#sidebarMenu").on("show.bs.collapse", function (e) {
        if ($(e.target).attr("id") != "sidebarMenu") {
            return;
        }
        $("#result").addClass("d-none");
