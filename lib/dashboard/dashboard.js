...
$(function() {
	...
	$(window).on("hashchange",function() {
		...
		// GUARDAR IDIOMA PER EL REDIRECCIONADOR
		var lang=window.location.href.split("/").pop().split("#")[0].split(".")[1];
...
function _amagar_menu() {
	if($("#menu").is(":visible") && $(".navbar-toggler").is(":visible")) $(".navbar-toggler").trigger("click");
}

function _amagar_result() {
	if($("#results").is(":visible")) $("#results").addClass("d-none").find("div").remove();
}
